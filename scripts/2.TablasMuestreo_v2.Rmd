...
# 2. Parámetros para tablas de muestreo
...
## Configuración de estimaciones puntuales y medidas de precisión
...
# Valor deseado en coeficiente de variación definido en focus group
...
## Estimación de otras medidas de precisión para los valores fijados para las diferentes variables trazadoras
...
## Integrar tablas urbanas y rurales
...
lista_nacional <- list(tablaMuestreo_desoc_Nacional, tablaMuestreo_pobreza_Nacional,
                       tablaMuestreo_pobrezaExtr_Nacional, tablaMuestreo_IPM_Urbana)
