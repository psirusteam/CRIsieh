...
# deff = V_p() / VMas  luego vMAS_d = v_p()_d / deff_d (tabla muestreo urb/rural) 
# como obtengo v_p() = (cve  * p) ^2
...
#V = (cve * P_gorro), con Pgorro, cve (el que deseamos no el de la encuesta que es menos exigente)
...
deff_nacional <- V_nacional / (V_MAS_Urbana + V_MAS_Rural) # Objetivo
