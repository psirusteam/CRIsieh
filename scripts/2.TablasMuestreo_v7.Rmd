...
# Consolidación información por dominios y nacional


```{r}
bind_rows(df_pobreza_region, df_pobreza)
```


```{r}
bind_rows(df_pobreza_area, df_pobreza)
```
...
```{r}
bind_rows(df_pobrezaExtr_region, df_pobrezaExtr)
```

```{r}
bind_rows(df_pobrezaExtr_area, df_pobrezaExtr)
```
...
```{r}
bind_rows(df_NBI_region, df_NBI)
```
...
```{r}
bind_rows(df_Desocupacion_region, df_Desocupacion)
```


```{r}
bind_rows(df_Desocupacion_area, df_Desocupacion)
```
